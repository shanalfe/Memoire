...
\begin{titlepage}
    \begin{center}
        ...
        {\huge \textbf{État de l'art - Mémoire de Master}}\\[1cm]

        \textbf{Année universitaire :} \\[0.5cm]
        {\Large \textbf{2024/2025}}\\[1cm]
                {\Large \textbf{Shana LEFEVRE}}\\[1cm]
                \begin{figure}[h]
    \centering
...
Les \textbf{communications V2V (Vehicle-to-Vehicle) et V2I (Vehicle-to-Infrastructure)} font partie des technologies de transport intelligent (ITS) qui permettent aux véhicules et aux infrastructures routières d’échanger des informations en temps réel.
...
- Communication infrastructure au véhicule (V2I):\\
...
Les capteurs IoT intégrés surveillent l'état des composants du véhicule, la consommation de carburant et la température du moteur. 
