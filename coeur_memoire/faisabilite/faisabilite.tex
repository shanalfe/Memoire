...
Ces données offrent la possibilité de mettre en évidence des comportements personnels ou de reconnaître des trajets effectués de manière régulière par un usager. De ce fait, tout dispositif embarqué ou toute application exploitant ces informations doit impérativement se conformer au Règlement Général sur la Protection des Données (RGPD), en vigueur au sein de l’Union européenne.
Pour perfectionner le fonctionnement du système, il sera indispensable de collecter, suivre et analyser les données GPS générées par l’usager. \\
Cependant, cette approche ne peut être considérée qu'avec l'accord explicite et informé du motocycliste. Une politique de confidentialité explicite et transparente doit accompagner ce dernier, précisant les buts de la collecte d'informations, l'utilisation prévue des données et les modalités de leur conservation.
