...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/schéma_cycle_vie_donneées.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ADAS_schéma.jpg} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{etat_art/images/témoignage géoride.png} 
...
%perspectives
Plusieurs nouvelles aides et alertes sont en cours de développement pour les motos. Parmis elles, on retrouve :
\begin{itemize}
