...
\begin{itemize}
    ...
    \item Emergency Brake Assist: Illustré par la Figure~\ref{detecteuravant} freinage d’urgence en cas de risque de collision.
\end{itemize}
...
\end{figure}
- Rear Collision Warning: Illustré par la Figure~\ref{detecteurarriere} détecte si un véhicule s'approche trop près par l'arrière et active les feux de détresse en cas de risque de collision. 
\begin{figure}[H]
    \centering
